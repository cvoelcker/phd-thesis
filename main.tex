...
\begin{document}
  ...
  \appendix
    ...
    \include{chapters/04-02-appendix-overestimation}
    \include{chapters/04-03-appendix-understanding}
    \include{chapters/04-04-appendix-vagram}
    \include{chapters/04-05-appendix-lambda}
    \include{chapters/04-06-appendix-minimal}
  \backmatter
\end{document}
