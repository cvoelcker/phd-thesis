...
\revised{\paragraph{Suboptimal local minima} %
...
We denote the diagonal matrix with vector $a$ on the diagonal as $\text{diag}(a)$ and refer to the dimensionality of the state space as $\text{dim}(\states)$ and rephrase the sum as a vector-matrix multiplication:
\begin{align}
