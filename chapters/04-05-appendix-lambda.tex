...
Our source code is available under \url{https://github.com/adaptive-agents-lab/CVAML}.
...
In addition to the raw performance graphs in \autoref{sec:cvaml:empirical2} we present the average model entropy and VAML loss curves in \autoref{fig:vaml_entropy}.
