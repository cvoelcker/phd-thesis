...
\begin{table}[H]
    ...
    \begin{tabular}{ | m{3.5cm} | m{2cm}| }
      ...
      \hline
      Actor Learning Rate & $4\times 10^{-3}$ \\ 
      \hline
      Critic Learning Rate & $4\times 10^{-3}$ \\ 
      \hline
      Temp. Learning Rate & $3\times 10^{-4}$ \\ 
      \hline
      Batch Size
      & $256$ \\ 
      \hline
...
Let $i \in {1, \dots, n}$, for all $\mathbf{x} = (x_1, ..., x_n) \in \mathbb{R}^n \setminus \{0\}$. Suppose $f(\mathbf{x}) = \cfrac{\mathbf{x}}{\| \mathbf{x} \|}$. 
