While a thesis is ostensibly the work of a single author, it is no secret that it is (almost) never written without the tireless support of many, many people.
...
Amir-massoud Farahmand, thank you for making me a critical scientist. 
You encouraged me tirelessly to become precise and clear in my thinking, experimentation, and writing, and my work is all the better for it.
Igor Gilitschenski, thank you for stepping up when I needed help.
You were the person I could always turn to with all my (very German) frustrations and worries, and your calm pragmatism saved me more than once.
In the same breath, I want to acknowledge the wonderful chair of my supervisory committee and mentor.
...
Additional thanks to the members of my examination committee Florian Shkurti, Philip Thomas, and Frank Kschischang.
...
And of course, a special \emph{thank you} to Maria Attarian for being the best office mate!

The next group of people is the biggest part of the acknowledgements, my friends and lab mates.
Roughly in order of appearance, I thank
the Adage lab and visitors, Amin, Romina, Avery, Farnam, Yangchen, Mete, Tyler and Sierra, Amarildo, and Jongmin; 
the (late) PAIR lab, Maria and Jon, Kate, Lily, Ziyi, Mayank, and Dylan; 
the TISL lab and visitors, Ashkan and Sarah, Sam, Yash, Umangi, Evgenii, Jasper, Mohammad, Kai, Justin, Alfred, Shuhong, Andrei, Toshi, Axel, Eugen, and Marcel;
the CleverHans lab or extended Nicola mafia or potluck gang and visitors, Stefan, Mohammad, Avital, Sierra, Anvith, Patty, and David; 
friends from around Vector, especially Lukas, Taylor, Sep, and Shalev; 
representative for all the Vector staff, Abdur Mohammed and Jackie Zuborg, who were always quick to help with any problems; 
and finally, the great friends from all around DCS and the University of Toronto, especially Silvia and Gabriel.

Some friends have remained close after I moved to Toronto, and so a special thanks goes to Marcel, and the D120 and WiMi gang, Stefan and Maria, Julian and Gesine, Nadja, Benjamin and Steffi, Jannis, Anna and Philipp, Fabian and Steffi, Johny and Franzi, and Sial, Robyn, and Kay.
...
Of course, there are not enough words to express my thanks to my family, especially my mom and dad, Nikola and Hinrich, and my brother and sister-in-law, Till and Jasmine.
Without your love, encouragement, and support I would have never managed to get this far.

Finally, for Heiko, there simply are no words to adequately express everything I owe you.
Instead of words, you get me for the rest of my life.
