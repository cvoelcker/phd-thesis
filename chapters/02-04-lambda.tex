...
\begin{restatable}{proposition}{DeterministicModel}\label{prop:cvaml:3_1}
    ...
    $$f^* \in \argmin_{\hat{f}} \EEX{\rho,\P^\pi}{\hat{\mathcal{L}}_{\mathrm{IterVAML},1}(\hat{f},V_\mathcal{X}|x,x')}.$$
\end{restatable}
...
\begin{align}
     &\EEX{\rho,\P^\pi}{\hat{\mathcal{L}}_{\text{IterVAML}, 1}(f, V_\mathcal{X} | x, x' } \\
