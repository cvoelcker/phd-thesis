...
Plotting the associated Q values allows us to understand the difference between previous results and this one.
...
When combined with an auxiliary loss, both loss variants learn non-trivial policies across all tasks, as we will see in the next section.
