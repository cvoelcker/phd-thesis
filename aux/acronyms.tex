...
\acrodef{td}[TD]{Temporal Difference}
...
\acrodef{paml}[PAML]{Policy-gradient Aware Model Learning}
...
\acrodef{mbpo}[MBPO]{Model-based Policy Optimization}
...
\acrodef{brm}[BRM]{Bellman Residual Minimization}
